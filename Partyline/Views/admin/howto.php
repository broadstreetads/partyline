...
$icon    = esc_url( ( class_exists( 'Partyline_Pwa' ) ? Partyline_Pwa::assetUrl( 'icons/icon-192.png' ) : Partyline_Utility::getImageBaseURL() . 'partyline-p.png' ) );
...
.plg-hero { text-align:center; padding:46px 28px 42px; color:#fff;
            background:linear-gradient(135deg,#4f46e5 0%,#9333ea 52%,#ec4899 100%); }
.plg-hero img { width:78px; height:78px; border-radius:19px; box-shadow:0 10px 28px rgba(0,0,0,.28); }
.plg-hero h1 { margin:18px 0 8px; font-size:34px; font-weight:800; letter-spacing:-.02em; }
.plg-hero p { margin:0 auto; max-width:46ch; font-size:16px; line-height:1.55; opacity:.94; }

.plg-section { padding:36px 44px; border-top:1px solid #f1f1f3; }
...
@media (max-width:600px){ .plg-section{padding:28px 22px;} .plg-hero{padding:38px 20px;} }
</style>
...
<div class="plg">
  <div class="plg-wrap">
    ...
    <header class="plg-hero">
      <img src="<?php echo $icon; ?>" alt="Partyline">
      <h1>Welcome to Partyline</h1>
      <p>The community-powered newsroom. Here&rsquo;s what it is, where it came from, and how to make it thrive in your town.</p>
    </header>
    ...
    <section class="plg-section">
      ...
      <p>Partyline turns your readers into contributors. Anyone in your community can send in a photo and a few
        words &mdash; from the built-in app on their phone, or by text message &mdash; and it lands in your newsroom
        as a <strong>draft</strong>, ready for you to review and publish.</p>
      <div class="plg-features">
        ...
        <div class="plg-feature"><span class="ico">✨</span><div><strong>AI formatting (optional)</strong><span>Tidies up spelling and grammar and powers voice dictation &mdash; while staying true to the contributor&rsquo;s own words.</span></div></div>
      </div>
    ...
    <section class="plg-section">
      ...
      <p>Partyline was invented at <strong>Red Bank Green</strong> in Red Bank, New Jersey. We loved the old Red Bank
        ...
        today&rsquo;s news environment, that level of coverage just isn&rsquo;t economically feasible &mdash; but we
        also realized that <strong>local news is the original social media</strong>, and that it doesn&rsquo;t have
        to be a one-way street.</p>
      <p>If a community captures the things it thinks are important &mdash; the moments that matter to the people who
        live there &mdash; those things can be news too. Together, we believe a community can paint a better picture
        of a place and tell its story better than ever, maybe even better than the <em>Register</em> did. It&rsquo;s
        a deceptively simple idea, with a number of benefits that only reveal themselves in the unfolding of its use.</p>
    ...
    <section class="plg-section">
      ...
      <p class="plg-sub">A lovingly curated list from experience &mdash; originally shared with LINA Publishers in Australia.</p>
      <ol class="plg-tens">
        <li><span class="n">1</span><div><strong>Cover stories you&rsquo;d never get to otherwise</strong> &mdash; like proms, graduations, and scout ceremonies.</div></li>
        <li><span class="n">2</span><div><strong>Post ridiculous stuff that wouldn&rsquo;t fly as a &ldquo;real&rdquo; article</strong> &mdash; and watch the traffic surprise you.</div></li>
        <li><span class="n">3</span><div><strong>File an initial post when a breaking story hits</strong> &mdash; straight from the street.</div></li>
        <li><span class="n">4</span><div><strong>Capture the in-the-moment energy</strong> of a parade, protest, or town meeting.</div></li>
        <li><span class="n">5</span><div><strong>Share sunsets and puppy pics</strong> &mdash; without feeling like a complete sellout.</div></li>
        ...
        <li><span class="n">7</span><div><strong>Turn your readers into local mini-celebrities</strong> &mdash; and spark conversations offline.</div></li>
        <li><span class="n">8</span><div><strong>Give voice to people who never get quoted</strong> &mdash; Partyline lowers the barrier to entry.</div></li>
        <li><span class="n">9</span><div><strong>Redirect PR people</strong> to a more productive outlet than your inbox.</div></li>
        <li><span class="n">10</span><div><strong>Reclaim your newsroom&rsquo;s social media power</strong> &mdash; because you were doing it before Facebook anyway.</div></li>
      </ol>
      <h3>What to expect</h3>
      <p>Every Partyline arrives as a draft, so you always decide what runs. Expect a steady, manageable stream rather
        than a firehose &mdash; and treat what comes in as raw material. A quick edit (or the optional AI cleanup)
        turns a rough text into publishable copy. Quality will vary, and that&rsquo;s fine: the goal is coverage
        you&rsquo;d never get any other way.</p>
    </section>
    ...
    <section class="plg-section">
      ...
      <ol class="plg-steps">
        <li><span class="s">1</span><div><strong>General Settings</strong> &mdash; choose the <em>Partyline Category</em> that submissions are filed under, and add the <em>Email Notifications</em> addresses that should be pinged when one comes in.</div></li>
        <li><span class="s">2</span><div><strong>Contributor App</strong> &mdash; it&rsquo;s on by default. Share your app link with the community &mdash; people submit there, and can install it to their home screen like an app:
        ...
        <li><span class="s">3</span><div><strong>Text Messages (optional)</strong> &mdash; to also accept Partylines by text, enable Twilio, get a Twilio phone number, and point its messaging webhook at the URL shown in that section.</div></li>
        <li><span class="s">4</span><div><strong>AI Formatting (optional)</strong> &mdash; add an OpenAI API key to auto-format submissions and enable voice dictation. You can fine-tune the editorial voice with the <em>AI writing prompt</em>.</div></li>
      </ol>
      <p style="margin-top:16px;">Click <strong>Save</strong>, then open your app link on your phone and try it: take a photo, add a story, and
        submit &mdash; it&rsquo;ll show up in your drafts. To credit texters by name, register them as
    ...
    <section class="plg-section">
      ...
      <p>The single most important thing is a <strong>persistent call to action</strong>. You can&rsquo;t tell people
        once &mdash; you have to build the habit, until the moment someone sees something great in town, they
        instinctively think, <em>&ldquo;This should be a Partyline.&rdquo;</em></p>
      <ol class="plg-steps">
        <li><span class="s">1</span><div>Post about it and tell everybody.</div></li>
        <li><span class="s">2</span><div>Create a clear Partyline call to action &mdash; put the link (and a QR code) everywhere.</div></li>
      ...
      <div class="plg-features">
        ...
        <div class="plg-feature"><span class="ico">🏆</span><div><strong>Run a monthly contest</strong><span>Reward the best Partyline &mdash; and give out swag if you can. (At Red Bank Green, our best Partyliners get &ldquo;Long Live Local News&rdquo; swag.)</span></div></div>
      </div>
      <div class="plg-callout">And don&rsquo;t sweat quality control. You don&rsquo;t have to publish everything, and the fear of a garbage
        flood rarely comes true &mdash; in practice you get only a little garbage and a whole lot of sunsets and
        rainbows. You know what? <strong>Just post the sunsets and rainbows.</strong></div>
    </section>

    <div class="plg-tag">LONG LIVE LOCAL NEWS</div>
    <div class="plg-footer">Questions or a bug to report? Email <a href="mailto:frontdesk@broadstreetads.com">frontdesk@broadstreetads.com</a> &mdash; thanks for using Partyline.</div>
