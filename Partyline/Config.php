...
class Partyline_Config
{
     ...
     *  )
     *
     * I could use Partyline_Config::get('example-config.test.port') to get
     *  the port.
     ...
     *  to be accessed directly outside of this class, so use Partyline_Config::get()
     *  instead.
