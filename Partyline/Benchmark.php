...
class Partyline_Benchmark
{
    ...
    public static function start($timer_description = 'Anonymous Timer')
    {
        ...
        Partyline_Log::add('info', "Starting benchmark: $timer_description");
    }
    ...
    public static function stop($timer_description)
    {
        if(array_key_exists($timer_description, self::$_timers))
        {
            ...
            Partyline_Log::add('info', "Stopped benchmark: $seconds seconds for '$timer_description'");
            return $seconds;
        }
        else
        {
            Partyline_Log::add('warn', "Unknown benchmark 'stopped': $timer_description");
            return FALSE;
        }
    }
}
